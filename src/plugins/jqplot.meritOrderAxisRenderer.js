 ...
 */
(function($) {
    // class: $.jqplot.MeritOrderAxisRenderer
    ...
    $.jqplot.MeritOrderAxisRenderer = function() {
    };
    ...
    $.jqplot.MeritOrderAxisRenderer.prototype.draw = function(ctx, plot) {
        if (this.show) {
    ...
    $.jqplot.MeritOrderAxisRenderer.prototype.reset = function() {
        this.min = this._min;
        this.max = this._max;
    ...
    // called with scope of axis
    $.jqplot.MeritOrderAxisRenderer.prototype.set = function() { 
        var dim = 0;
        var temp;
        var w = 0;
        var h = 0;
    ...
    // called with scope of axis
    $.jqplot.MeritOrderAxisRenderer.prototype.createTicks = function() {
    ...
    // called with scope of axis
    $.jqplot.MeritOrderAxisRenderer.prototype.pack = function(pos, offsets) {
        var ticks = this._ticks;
        var max = this.max;
        var min = this.min;
